...
; Remarks .......:
; Note ..........:
; Author(s) .....: Melba23, based on some original code by photonbuddy & YellowLab, modified by CosmicDan
; ====================================================================================================================
...
; #FUNCTION# =========================================================================================================
; Name...........: _ExtMsgBoxSet
; Description ...: Sets the Taskbar presence, justification, colours and font for subsequent _ExtMsgBox function calls
...
; Name...........: _ExtMsgBox
; Description ...: Generates user defined message boxes centred on an owner, on screen or at defined coordinates
; Syntax.........: _ExtMsgBox ($vIcon, $iButton, $sTitle, $sText, [$iTimeout, [$hWin, [$iTop]]])
; Parameters ....: $vIcon       -> The $MB_ICON constant for the icon to use:
;                                  0 - No icon, 8 - UAC, 16 - Stop, 32 - Query, 48 - Exclamation, 64 - Information
...
;                   $iIcon      -> If using an external exe/dll, this is the index (with preceding -) or name of the
;                                  icon to use. Default of -1.
;
; Requirement(s).: v3.2.12.1 or higher
...
Func _ExtMsgBox($vIcon, $iButton, $sTitle, $sText, $iTimeout = 0, $hWin = "", $iVPos = 0, $iIcon = -1)

    Local $iParent_Win = 0, $fDisabled = True

    ; Save cuurent OnEvent setting
    ...
    ; Reset OnEvent setting
    $nOldOpt = Opt('GUIOnEventMode', $nOldOpt)

    ; Enable parent GUI
    If $fDisabled = True Then GUISetState(@SW_ENABLE, $hWin)
