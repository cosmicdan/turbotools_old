Func page_static_error($sPluginPath, $sPluginFilename)
	...
	Else
		$aPageCtrl[$iPageIndex][6] = GUICtrlCreateLabel("Turbo Tools has crashed. Press 'Debug' to dump current data index, or Bail Out to close." , 30, 100, $aTTWinMainCurrentSize[0]-80, 28)
		GUICtrlSetFont(-1, 10, 500, Default, "Trebuchet MS", 5)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKRIGHT + $GUI_DOCKTOP + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
	EndIf
